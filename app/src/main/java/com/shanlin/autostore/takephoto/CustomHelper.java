package com.shanlin.autostore.takephoto;
...
//            builder.setAspectX(80).setAspectY(80);
//        }else {
            builder.setOutputX(80).setOutputY(80);
//        }
