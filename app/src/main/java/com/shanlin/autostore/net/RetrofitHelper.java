...
public class RetrofitHelper {
    ...
    private OkHttpClient provideClient(OkHttpClient.Builder builder) {
        ...
        Interceptor apikey = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request request = chain.request();
                request = request.newBuilder()
                        .addHeader("token", SpUtils.getString(AutoStoreApplication.getApp(), Constant.TOKEN, ""))
                        .build();
    ...
    public HttpService provideApiService() {
        return createRetrofit(mClient,Constant.BASE_URL).create(HttpService.class);
    }
