...
public class LoginActivity2 extends BaseActivity {
    ...
    public LoginActivity2 mLoginActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_login_by_face://使用人脸识别快速登录
                ...
                CommonUtils.checkPermission(LoginActivity2.this, new MPermissionUtils.OnPermissionListener() {
                    @Override
                    public void onPermissionGranted() {
                        //CommonUtils.toNextActivity(LoginActivity.this, MainActivity.class);
                        Intent intent = new Intent(LoginActivity2.this, LivenessActivity.class);
                    ...
                    public void onPermissionDenied() {
                        MPermissionUtils.showTipsDialog(LoginActivity2.this);
                    }
                });
                break;
    ...
    private boolean isWeixinAvilible(LoginActivity2 loginActivity) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_LOGIN) {//人脸识别登陆
            ...
            try {
                ...
                Call<LoginBean> faceLoginBeanCall = httpService.postFaceLogin(new FaceLoginSendBean(encode, SpUtils.getString(LoginActivity2.this, Constant.DEVICEID, "")));
...
//                                //没人脸认证 跳转手机号登陆界面
//                                Intent intent = new Intent(LoginActivity2.this, PhoneNumLoginActivity.class);
...
//                                SpUtils.saveString(LoginActivity2.this, Constant.TOKEN, data.getData().getToken());
//                                SpUtils.saveString(LoginActivity2.this, Constant.USER_PHONE_LOGINED, data.getData().getMobile());
//                                if (!TextUtils.isEmpty(data.getData().getAvetorUrl())) {
//                                    SpUtils.saveString(LoginActivity2.this, Constant.USER_HEAD_URL, data.getData().getAvetorUrl());
//                                }
//                                //验证乐买宝实名是否认证
//                                CommonUtils.checkAuthenStatus(LoginActivity2.this, httpService, data.getData().getToken());
...
//                            return;
//                        }
//                        SpUtils.saveString(LoginActivity2.this, Constant.WX_NICKNAME, nickname);
//                        if (TextUtils.equals(data.getData().getFaceVerify(), "0")) {
//                            //没人脸认证 跳转手机号登陆界面
//                            Intent intent = new Intent(LoginActivity2.this, PhoneNumLoginActivity.class);
//                            intent.putExtra(Constant.FACE_VERIFY, Constant.FACE_VERIFY_NO);
...
//                            SpUtils.saveString(LoginActivity2.this, Constant.TOKEN, data.getData().getToken());
//                            if (TextUtils.isEmpty(data.getData().getAvetorUrl())) {
//                                SpUtils.saveString(LoginActivity2.this, Constant.USER_HEAD_URL, wxUserInfoBean.getHeadimgurl());
//                            } else {
//                                SpUtils.saveString(LoginActivity2.this, Constant.USER_HEAD_URL, data.getData().getAvetorUrl());
//                            }
//                            SpUtils.saveString(LoginActivity2.this, Constant.USER_PHONE_LOGINED, data.getData().getMobile());
