package com.shanlin.android.autostore.receiver;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {//save id
                ...
                SpUtils.saveString(App.getInstance(), Constant.DEVICEID, regId);
                CommonUtils.saveDevicedID(regId);
                Log.d("deviceId", "deviceId: onReceive-- " + SpUtils.getString(App.getInstance(), "deviceId", ""));
