...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //        Log.d(LOG_TAG, "debug:onLayout childHeight = " + childHeight + " /// childTop = " + childTop);
        ...
        //        Logger.d("onLayout========top=%d,bottom=%d",height-pushDistance,height + footViewHeight -pushDistance);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        //        MyLogger.getLogger().d("qqqqq interept top=%s,bottom=%s",isScrollToTop,isScrollToBottom);
        if (!isEnabled() || mReturningToStart || mRefreshing || mLoadMore || (!isScrollToTop && !isScrollToBottom)) {
            ...
            Log.d("onInterceptTouchEvent", "onInterceptTouchEvent: // 如果子View可以滑动，不拦截事件，交给子View处理-下拉刷新");
            return false;
        }
        boolean lock = false;
        // 下拉刷新判断
