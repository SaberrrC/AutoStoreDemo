package com.shanlin.android.autostore.ui.view;

/**
 * Created by zhengw on 2016/1/4.
 */
...
import com.shanlin.android.autostore.common.utils.UIUtils;
...
//    private TextView mTvPullRefreshTip;
    ...
    private void createView(Context context, AttributeSet attrs){
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PulltoRefreshRecyclerView);
...
//                mIvPullRefreshArrow.setVisibility(GONE);
                try {
                    mIvPullRefreshArrow.setImageResource(R.drawable.anim_loading);
...
//        mRecyclerView.setOnScrollListener(mScrollListener);
    ...
    private void createHeadView(){
        ...
        mIvPullRefreshArrow = UIUtils.findViewById(headView,R.id.iv_pullrefresh_head);
//        mTvPullRefreshTip = UIUtils.findViewById(headView,R.id.tv_pullrefresh_tip);
    ...
    private void createFootView(){
        ...
        View footView = LayoutInflater.from(mContext).inflate(R.layout.load_more_layout, this, false);
        mIvFootLoad = UIUtils.findViewById(footView,R.id.infoOperating);
        mTvFootLoadMoreTip = UIUtils.findViewById(footView,R.id.tv_load_more_tip);
...
//        setEnabled(enable);
    ...
    public void stopRefresh() {
        ...
        mIvPullRefreshArrow.setImageResource(R.drawable.preloader_2_00000);
    }
