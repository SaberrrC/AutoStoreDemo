package com.shanlin.android.autostore.ui.view.gridpasswordview;
...
import com.shanlin.android.autostore.ui.view.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
//                sb.append(mPasswordArr[i]);
            if (mViewArr[i].getText() != null) {
                sb.append(mViewArr[i].getText());
            }
        }
        return sb.toString();
    }
